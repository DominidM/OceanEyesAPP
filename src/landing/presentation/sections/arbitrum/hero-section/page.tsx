  ...
  return (
    <View style={[styles.hero, isMobile && styles.heroMobile]}>
      ...
      <View style={[styles.heroContent, isMobile && styles.heroContentMobile]}>
        <Text style={[styles.heroTitle, isMobile && styles.heroTitleMobile]}>Arbitrum</Text>
        <Text style={styles.heroSubtitle}>
          Registro inmutable y transparente de las recompensas en Arbitrum Sepolia.
        </Text>
      </View>
    </View>
  );
