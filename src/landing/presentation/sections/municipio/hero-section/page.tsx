  ...
  return (
    <View style={[styles.hero, isMobile && styles.heroMobile]}>
      ...
      <View style={[styles.heroContent, isMobile && styles.heroContentMobile]}>
        <Text style={[styles.heroTitle, isMobile && styles.heroTitleMobile]}>Municipalidades</Text>
        <Text style={styles.heroSubtitle}>
          Suma tu distrito a OceanEyes y emite alertas oficiales para proteger tu costa.
        </Text>
      </View>
    </View>
  );
