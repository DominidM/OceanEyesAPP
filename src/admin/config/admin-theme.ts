...
export const THEME_TRANSITION = 'background-color 350ms ease, border-color 350ms ease, color 350ms ease';

export const themeTransition = { transition: THEME_TRANSITION } as Record<string, string>;
